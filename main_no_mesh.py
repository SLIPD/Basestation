...
try:
    ...
    if(socketConnection.connectAsSender()):
        ...
        while True:
            time.sleep(1)
            data = '\x00\x00\x00\x01\x00\x00\x03\x4F\xE7\x3F\x00\x01\xE9\x36\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
            #data = '\x01\x00\x00\x01\x00\x00\x98\xdf\x4f'
            #data.append(random.randrange(0,255) & 0xFF)
            #data.append('\xc7\x9e\xd0\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
